...
export class ActorP2P<T extends ActorP2P = RPortalP2P> extends Actor {
  ...
  private ctx: actorManager | cloudSpace; // Store the context
  

  constructor(actorname: string, publicIp: string, ctx: actorManager | cloudSpace, state?: SerializedState<Actor>, ) {
    super(state)
